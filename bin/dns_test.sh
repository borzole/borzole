...
# This is to test which DNS service resolves faster
# https://bbs.archlinux.org/viewtopic.php?pid=696054#p696054
...
echo "${h}";
for i in "google.com" "onet.pl" "fedora.pl" "jedral.one.pl";
do
  ii="${i}${s:23}";
  echo -ne "| ${ii:0:23} |";
